...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By LISA' : process.env.ALL_CAPTION,
    ...
    BOTLIZA: process.env.BOT_NAME === undefined ? '  Lɪsᴀ  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? '𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗜𝗡𝗚...' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '𝗨𝗣𝗟𝗢𝗔𝗗𝗜𝗡𝗚...' : process.env.SONGU,
    ...
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? 'LISA' : process.env.OWNER_SHIP,
    LISA: process.env.LOGO_LINK === undefined ? 'https://imgur.com/gallery/D2FxJVC' : process.env.LOGO_LINK,
    MWOL: process.env.BGM_DURATION === undefined ? '7280542' : process.env.BGM_DURATION,
    BOTV2: process.env.BOTV2_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ʟɪsᴀ࿐: process.env.BOTV2_NAME,
    LISA_AI: process.env.LISA_AI === undefined ? 'false' : process.env.LISA_AI,
    ...
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://te.legra.ph/file/135ff53bacbbdb034eb44.jpg' : process.env.LG_LOGO,
    JID: process.env.VERIFIED === undefined ? '0@s.whatsapp.net' : process.env.VERIFIED,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ʟɪsᴀ࿐' : process.env.LOGO_NAME,
